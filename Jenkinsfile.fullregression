    ...
    post {
        always {
            dir("site") {
                ...
                sh "docker-compose -f docker-compose-selenium-grid.yaml down || true"
                sh "docker-compose -f docker-compose-app.yaml down || true"
            }
            script {
                        ...
                        statusResultSource: [
                            ...
                            results: [
                                [$class: "AnyBuildResult",
                                 ...
                                 message: "Jenkins E2E: ${currentBuild.currentResult}"]
                            ]
                        ]
                    ])
                }
