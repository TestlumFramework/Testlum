package com.testlum.comparator.constant;

import com.testlum.comparator.condition.Operator;
...
public class RegexpConstant {
    ...
    public static final Pattern MORE_THEN_INT = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.MORE_THEN.getOperatorSign(), ANY_INT));
    public static final Pattern LESS_THEN_INT = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.LESS_THEN.getOperatorSign(), ANY_INT));
    public static final Pattern MORE_THEN_INT_OR_EQUAL = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.MORE_THEN_OR_EQUAL.getOperatorSign(), ANY_INT));
    public static final Pattern LESS_THEN_INT_OR_EQUAL = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.LESS_THEN_OR_EQUAL.getOperatorSign(), ANY_INT));
    public static final Pattern MORE_THEN_DECIMAL = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.MORE_THEN.getOperatorSign(), ANY_DECIMAL));
    public static final Pattern LESS_THEN_DECIMAL = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.LESS_THEN.getOperatorSign(), ANY_DECIMAL));
    public static final Pattern MORE_THEN_DECIMAL_OR_EQUAL = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.MORE_THEN_OR_EQUAL.getOperatorSign(), ANY_DECIMAL));
    public static final Pattern LESS_THEN_DECIMAL_OR_EQUAL = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.LESS_THEN_OR_EQUAL.getOperatorSign(), ANY_DECIMAL));
    public static final Pattern MORE_THEN_DATE_TIME_WITH_DASH = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.MORE_THEN.getOperatorSign(), RegexpConstant.DATE_TIME_WITH_DASH));
    public static final Pattern MORE_THEN_DATE_TIME_WITH_SLASH = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.MORE_THEN.getOperatorSign(), RegexpConstant.DATE_TIME_WITH_SLASH));
    public static final Pattern LESS_THEN_DATE_TIME_WITH_DASH = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.LESS_THEN.getOperatorSign(), RegexpConstant.DATE_TIME_WITH_DASH));
    public static final Pattern LESS_THEN_DATE_TIME_WITH_SLASH =
            Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
                    Operator.LESS_THEN.getOperatorSign(), RegexpConstant.DATE_TIME_WITH_SLASH));
    public static final Pattern MORE_THEN_DATE_TIME_WITH_DASH_OR_EQUAL =
            Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
    ...
    public static final Pattern MORE_THEN_DATE_WITH_DASH = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.MORE_THEN.getOperatorSign(), RegexpConstant.DATE_WITH_DASH));
    public static final Pattern MORE_THEN_DATE_WITH_SLASH = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.MORE_THEN.getOperatorSign(), RegexpConstant.DATE_WITH_SLASH));
    public static final Pattern LESS_THEN_DATE_WITH_DASH = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.LESS_THEN.getOperatorSign(), RegexpConstant.DATE_WITH_DASH));
    public static final Pattern LESS_THEN_DATE_WITH_SLASH = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.LESS_THEN.getOperatorSign(), RegexpConstant.DATE_WITH_SLASH));
    public static final Pattern MORE_THEN_DATE_WITH_DASH_OR_EQUAL =
            Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
                    Operator.MORE_THEN_OR_EQUAL.getOperatorSign(), RegexpConstant.DATE_WITH_DASH));
    public static final Pattern MORE_THEN_DATE_WITH_SLASH_OR_EQUAL =
            Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
                    Operator.MORE_THEN_OR_EQUAL.getOperatorSign(), RegexpConstant.DATE_WITH_SLASH));
    public static final Pattern LESS_THEN_DATE_WITH_DASH_OR_EQUAL =
            Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
                    Operator.LESS_THEN_OR_EQUAL.getOperatorSign(), RegexpConstant.DATE_WITH_DASH));
    public static final Pattern LESS_THEN_DATE_WITH_SLASH_OR_EQUAL =
            Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
                    Operator.LESS_THEN_OR_EQUAL.getOperatorSign(), RegexpConstant.DATE_WITH_SLASH));
    public static final Pattern MORE_THEN_TIME = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.MORE_THEN.getOperatorSign(), RegexpConstant.TIME));
    public static final Pattern LESS_THEN_TIME = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.LESS_THEN.getOperatorSign(), RegexpConstant.TIME));
    public static final Pattern MORE_THEN_TIME_OR_EQUAL = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.MORE_THEN_OR_EQUAL.getOperatorSign(), RegexpConstant.TIME));
    public static final Pattern LESS_THEN_TIME_OR_EQUAL = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.LESS_THEN_OR_EQUAL.getOperatorSign(), RegexpConstant.TIME));
    public static final Pattern MORE_THEN_NOW = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.MORE_THEN.getOperatorSign(), NOW_FOR_REGEXP));
    public static final Pattern LESS_THEN_NOW = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.LESS_THEN.getOperatorSign(), NOW_FOR_REGEXP));
    public static final Pattern MORE_THEN_NOW_OR_EQUAL = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
            Operator.MORE_THEN_OR_EQUAL.getOperatorSign(), NOW_FOR_REGEXP));
    public static final Pattern LESS_THEN_NOW_OR_EQUAL = Pattern.compile(String.format(TEMPLATE_FOR_CONDITIONS,
