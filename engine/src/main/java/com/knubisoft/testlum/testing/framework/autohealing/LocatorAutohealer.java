...
public class LocatorAutohealer {
    ...
    public LocatorAutohealer(final ExecutorDependencies dependencies, final JacksonService jacksonService) {
    ...
    private File generatePatchForLocatorDefinedInScenario(final ExecutorDependencies dependencies,
        ...
        if (isLocatorDefinedInLocatorFile) {
            ...
            FileUtils.writeStringToFile(patch,
                    jacksonService.writeValueAsStringWithDefaultPrettyPrinter(healedLocators), defaultCharset());
            return patch;
        }
