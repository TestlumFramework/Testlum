...
public class ExceptionMessage {
    ...
    public static final String FUNCTION_FOR_COMMAND_NOT_FOUND =
            "Function for class %s not found. Please register algorithm for interpreter";
    public static final String NOT_DECLARED_WITH_EXECUTOR_FOR_CLASS =
            "Each non abstract executor must declare annotation ExecutorForClass. Class %s do not have this annotation";
    public static final String EXECUTOR_FOR_UI_COMMAND_NOT_FOUND =
            "Executor for class %s not found";
    public static final String INTERPRETER_NOT_FOUND =
            "Interpreter for class %s not found";
    public static final String MISSING_CONSTRUCTOR =
            "Missing constructor for class: %s";

    public static final String ALIAS_BY_STORAGE_NAME_NOT_FOUND =
            "Alias for data storage [%s] not found. Available aliases are %s";
    ...
    public static final String NO_ENABLED_REPORT_GENERATORS_FOUND =
            ANSI_RED + "At least one report generator must be enabled" + ANSI_RESET;
    public static final String STOP_IF_NON_PARSED_SCENARIO =
            ANSI_YELLOW + "The execution has been stopped because of the enabled <StopIfInvalidScenario>" + ANSI_RESET;
    public static final String VALID_SCENARIOS_NOT_FOUND =
            ANSI_RED + "Valid scenarios are not found" + ANSI_RESET;
    public static final String NO_SCENARIOS_FILTERED_BY_TAGS =
            ANSI_RED + "There are no active scenarios by enabled tags" + ANSI_RESET;
    public static final String NO_ENABLED_TAGS_CONFIG =
            ANSI_RED + "No enabled tags in runScenariosByTag configuration" + ANSI_RESET;
    ...
    public static final String ALIAS_NOT_FOUND =
            "Cannot find enabled integration with alias <%s>";
    public static final String API_NOT_FOUND =
            "Cannot find api with alias <%s>";
    public static final String AUTH_NOT_FOUND =
            "Cannot find <auth> configuration for <api> with alias <%s>";
    public static final String AUTH_ALIASES_DOESNT_MATCH =
            "<Http> command alias doesn't match with <auth> alias";

    public static final String SCENARIO_CANNOT_BE_INCLUDED_TO_ITSELF =
            "Scenario cannot be included to itself";
    public static final String UNSUPPORTED_MIGRATION_FORMAT =
            "Unsupported data file format was found in <migration> tag. For %s allowed extensions are: %s, %s";
