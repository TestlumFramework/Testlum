...
public class InterpreterProvider {
    ...
    public AbstractInterpreter<AbstractCommand> getAppropriateInterpreter(final AbstractCommand command,
        ...
        if (Objects.isNull(interpreter)) {
            throw new DefaultFrameworkException(ExceptionMessage.INTERPRETER_NOT_FOUND, command.getClass());
        }
        try {
            ...
            throw new DefaultFrameworkException(ExceptionMessage.MISSING_CONSTRUCTOR, interpreter, e);
        }
    }
}
