...
<overview>
    ...
    <testRail enable="true" testRailRunId="1" testCaseId="1"/>
</overview>
```
...
<overview>
    ...
    <testRail enable="true" testCaseId="1"/>
</overview>
```
...
2️⃣ All scenarios with `<testRail enable="true" ... />` are collected.
