...
public class UiUtil {
    ...
    private WebElement getMatSelectPanel(ExecutorDependencies dependencies, WebElement matSelect) {
        ...
        WebElement panel = dependencies.getDriver().findElement(org.openqa.selenium.By.id(panelId));
    ...
    private String extractOptionText(WebElement option) {
        List<WebElement> spans = option.findElements(org.openqa.selenium.By.cssSelector("span"));
