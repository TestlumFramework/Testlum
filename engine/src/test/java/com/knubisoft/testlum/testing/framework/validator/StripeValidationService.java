...
import com.knubisoft.testlum.testing.model.global_config.SubscriptionType;
...
public class StripeValidationService implements SubscriptionValidator {
    ...
    private static final String TESTLUM_ACCOUNT = "acct_1MEAdcDGir2utiID";
    ...
    private RequestOptions buildRequestOptions() {
        return RequestOptions.builder()
                ...
                .setStripeAccount(TESTLUM_ACCOUNT)
