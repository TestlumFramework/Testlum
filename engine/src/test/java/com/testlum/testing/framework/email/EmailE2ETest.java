...
class EmailE2ETest {
    ...
    void setUp() {
        ...
        final EmailExecutionService emailExecutionService = new EmailExecutionService(prettifier);
        ...
        lenient().when(this.context.getBean(EmailExecutionService.class)).thenReturn(emailExecutionService);
