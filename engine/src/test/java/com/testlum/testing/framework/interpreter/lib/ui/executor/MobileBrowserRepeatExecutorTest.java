...
import com.testlum.testing.model.scenario.MobilebrowserRepeat;
...
class MobileBrowserRepeatExecutorTest {
    ...
    private MobileBrowserRepeatExecutor executor;
    ...
    void setUp() {
        ...
        ExecutorDependencies deps = ExecutorDependencies.builder()
                ...
                .driver(driver)
                .build();
        executor = new MobileBrowserRepeatExecutor(deps);
    ...
    class Execute {
        ...
        void simpleRepeatWithZeroTimes() {
            MobilebrowserRepeat repeat = new MobilebrowserRepeat();
            repeat.setTimes(0);
