...
import com.testlum.testing.framework.interpreter.SendGridUtil;
...
import com.testlum.testing.framework.util.DatasetValidator;
...
import com.testlum.testing.framework.xml.XMLValidator;
...
class ScenarioValidatorTest {
    ...
    class ValidateWebCommands {
        ...
        void throwsWhenWebNotEnabled() {
            com.testlum.testing.model.global_config.Web webConfig =
                    mock(com.testlum.testing.model.global_config.Web.class);
            ...
            when(browserUtil.filterDefaultEnabledBrowsers()).thenReturn(List.of(mock(
                    com.testlum.testing.model.global_config.AbstractBrowser.class)));
    ...
    class ValidateMobileBrowserCommands {
        ...
        void throwsWhenMobileBrowserNotEnabled() {
            com.testlum.testing.model.global_config.Mobilebrowser mbConfig =
                    mock(com.testlum.testing.model.global_config.Mobilebrowser.class);
            when(mbConfig.isEnabled()).thenReturn(false);
            when(uiConfig.getMobilebrowser()).thenReturn(mbConfig);
            when(mobileUtil.filterDefaultEnabledMobileBrowserDevices())
                    .thenReturn(List.of(mock(
                            com.testlum.testing.model.global_config.MobilebrowserDevice.class)));
    ...
    class ValidateNativeCommands {
        ...
        void throwsWhenNativeNotEnabled() {
            com.testlum.testing.model.global_config.Native nativeConfig =
                    mock(com.testlum.testing.model.global_config.Native.class);
            when(nativeConfig.isEnabled()).thenReturn(false);
            when(uiConfig.getNative()).thenReturn(nativeConfig);
            when(mobileUtil.filterDefaultEnabledNativeDevices())
                    .thenReturn(List.of(mock(
                            com.testlum.testing.model.global_config.NativeDevice.class)));
