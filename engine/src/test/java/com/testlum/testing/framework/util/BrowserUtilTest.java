...
import com.testlum.testing.framework.util.BrowserUtil.BrowserType;
...
class BrowserUtilTest {
    ...
    class GetBrowserType {
        ...
        void returnsRemoteWhenRemoteBrowserIsNotNull() {
            AbstractBrowser browser = mock(AbstractBrowser.class);
            com.testlum.testing.model.global_config.BrowserType browserTypeObj =
                    mock(com.testlum.testing.model.global_config.BrowserType.class);
