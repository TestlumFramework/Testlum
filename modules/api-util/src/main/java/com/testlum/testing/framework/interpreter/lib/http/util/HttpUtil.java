...
public final class HttpUtil {
    ...
    public void fillHeadersMap(final List<com.testlum.testing.model.scenario.Header> headerList,
        ...
        for (com.testlum.testing.model.scenario.Header header : headerList) {
