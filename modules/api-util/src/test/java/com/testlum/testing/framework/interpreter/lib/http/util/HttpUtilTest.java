package com.testlum.testing.framework.interpreter.lib.http.util;
...
class HttpUtilTest {
    ...
    class FillHeadersMap {
        ...
        void addsExplicitHeaders() {
            final Map<String, String> headers = new LinkedHashMap<>();
            final com.testlum.testing.model.scenario.Header h1 =
                    new com.testlum.testing.model.scenario.Header();
            h1.setName("X-Custom");
            h1.setData("value1");
            final java.util.List<com.testlum.testing.model.scenario.Header> headerList =
                    new ArrayList<>();
            headerList.add(h1);
        ...
        void multipleExplicitHeaders() {
            final Map<String, String> headers = new LinkedHashMap<>();
            final java.util.List<com.testlum.testing.model.scenario.Header> headerList = new ArrayList<>();
            ...
            final com.testlum.testing.model.scenario.Header h2 =
                    new com.testlum.testing.model.scenario.Header();
    ...
    class ExtractBody {
        ...
        void fileBodyReturnsStringEntity() {
            final Body body = new Body();
            final com.testlum.testing.model.scenario.File from =
                    new com.testlum.testing.model.scenario.File();
