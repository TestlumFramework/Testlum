...
import com.testlum.testing.framework.db.AbstractStorageOperation.QueryResult;
import com.testlum.testing.framework.db.AbstractStorageOperation.StorageOperationResult;
import com.testlum.testing.framework.db.source.ListSource;
...
class SqlOperationImplTest {
    ...
    private void injectIntegrationsProvider(final AbstractSqlOperation operation) {
        try {
            Field field = com.testlum.testing.framework.db.AbstractStorageOperation.class
