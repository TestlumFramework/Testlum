package com.testlum.testing.framework.configuration.elasticsearch;
...
public class ElasticsearchConfiguration {
    ...
    @Bean
    public Map<String, List<Elasticsearch>> getElasticsearchMap(final EnvToIntegrationMap envTointegrations) {
