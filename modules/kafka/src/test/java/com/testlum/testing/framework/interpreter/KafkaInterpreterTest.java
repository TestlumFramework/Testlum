...
import com.testlum.testing.model.scenario.KafkaHeader;
import com.testlum.testing.model.scenario.KafkaHeaders;
import com.testlum.testing.model.scenario.ReceiveKafkaMessage;
import com.testlum.testing.model.scenario.SendKafkaMessage;
...
class KafkaInterpreterTest {
    ...
    class GetAlias {
        ...
        void returnsAliasFromCommand() throws Exception {
            final com.testlum.testing.model.scenario.Kafka command =
                    new com.testlum.testing.model.scenario.Kafka();
            command.setAlias("testAlias");

            final Method method = KafkaInterpreter.class.getDeclaredMethod(
                    "getAlias", com.testlum.testing.model.scenario.Kafka.class);
            method.setAccessible(true);
    ...
    class SetAlias {
        ...
        void setsAliasOnCommand() throws Exception {
            ...
            final Method method = KafkaInterpreter.class.getDeclaredMethod(
                    "setAlias", com.testlum.testing.model.scenario.Kafka.class, String.class);
            method.setAccessible(true);
