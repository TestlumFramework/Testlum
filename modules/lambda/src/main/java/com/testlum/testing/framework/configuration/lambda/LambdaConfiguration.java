package com.testlum.testing.framework.configuration.lambda;
...
import com.testlum.testing.framework.condition.OnLambdaEnabledCondition;
...
public class LambdaConfiguration {
    ...
    @Bean
    public Map<AliasEnv, LambdaClient> awsLambdaClients(final EnvToIntegrationMap envTointegrations) {
