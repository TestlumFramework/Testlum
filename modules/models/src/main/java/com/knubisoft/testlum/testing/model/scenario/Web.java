 ...
 *         &lt;element name="inputGoogleAuthToken" type="{http://www.knubisoft.com/testlum/testing/model/scenario}inputGoogleAuthToken"/&gt;
 *       &lt;/choice&gt;
    ...
    extends Ui
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "inputGoogleAuthToken", type = InputGoogleAuthToken.class)
    })
