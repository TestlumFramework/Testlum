 ...
 *         &lt;element name="chrome" type="{http://www.testlum.com/testing/model/global-config}chrome"/&gt;
 *         &lt;element name="firefox" type="{http://www.testlum.com/testing/model/global-config}firefox"/&gt;
 *         &lt;element name="safari" type="{http://www.testlum.com/testing/model/global-config}safari"/&gt;
 *         &lt;element name="edge" type="{http://www.testlum.com/testing/model/global-config}edge"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
