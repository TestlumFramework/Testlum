 ...
 *         &lt;element name="copy" type="{http://www.testlum.com/testing/model/scenario}copy"/&gt;
 *         &lt;element name="paste" type="{http://www.testlum.com/testing/model/scenario}paste"/&gt;
 *         &lt;element name="cut" type="{http://www.testlum.com/testing/model/scenario}cut"/&gt;
 *         &lt;element name="highlight" type="{http://www.testlum.com/testing/model/scenario}highlight"/&gt;
 *         &lt;element name="tab" type="{http://www.testlum.com/testing/model/scenario}tab"/&gt;
 *         &lt;element name="enter" type="{http://www.testlum.com/testing/model/scenario}enter"/&gt;
 *         &lt;element name="escape" type="{http://www.testlum.com/testing/model/scenario}escape"/&gt;
 *         &lt;element name="space" type="{http://www.testlum.com/testing/model/scenario}space"/&gt;
 *         &lt;element name="backSpace" type="{http://www.testlum.com/testing/model/scenario}backSpace"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
