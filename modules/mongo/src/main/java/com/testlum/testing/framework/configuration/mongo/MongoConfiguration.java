package com.testlum.testing.framework.configuration.mongo;
...
import com.testlum.testing.framework.condition.OnMongoEnabledCondition;
...
public class MongoConfiguration {
    ...
    @Bean
    public Map<AliasEnv, MongoDatabase> mongoDatabases(final EnvToIntegrationMap envTointegrations) {
