package com.testlum.testing.framework.db.redis;

import com.testlum.testing.framework.condition.OnRedisEnabledCondition;
...
import com.testlum.testing.model.scenario.RedisQuery;
...
public class RedisOperation extends AbstractStorageOperation {
    ...
    private String executeQuery(final String query, final String databaseAlias) {
        RedisQuery redisQuery = jacksonService.readValue(query, RedisQuery.class);
