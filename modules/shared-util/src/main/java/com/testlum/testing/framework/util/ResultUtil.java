...
import com.testlum.testing.framework.report.CommandResultHelper;
...
public class ResultUtil {
    ...
    private static String formatExcluded(final Exclude exclude) {
        ...
        return String.format("X: %d, Y: %d, width: %d, height: %d",
                byArea.getX(), byArea.getY(), byArea.getWidth(), byArea.getHeight());
    }
