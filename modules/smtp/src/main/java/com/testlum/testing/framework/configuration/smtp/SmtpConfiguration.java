...
import com.testlum.testing.framework.condition.OnSmtpEnabledCondition;
...
public class SmtpConfiguration {
    ...
    @Bean("javaMailSender")
    public Map<AliasEnv, JavaMailSenderImpl> javaMailSender(final EnvToIntegrationMap envToIntegrations) {
