package com.testlum.testing.framework.configuration.twilio;
...
import com.testlum.testing.framework.condition.OnTwilioEnabledCondition;
...
public class TwilioConfiguration {
    ...
    @Bean
    public Map<AliasEnv, Twilio> twilio(final EnvToIntegrationMap envToIntegrations) {
