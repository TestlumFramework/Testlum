...
import com.testlum.testing.model.scenario.Twilio;
...
public class TwilioInterpreter extends AbstractInterpreter<Twilio> {
    ...
    private Map<AliasEnv, com.testlum.testing.model.global_config.Twilio> twilioSettings;
    ...
    protected void acceptImpl(final Twilio o, final CommandResult result) {
        ...
        com.testlum.testing.model.global_config.Twilio twilioSetting = twilioSettings.get(aliasEnv);
