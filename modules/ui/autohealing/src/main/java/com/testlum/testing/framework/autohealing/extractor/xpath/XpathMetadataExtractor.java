package com.testlum.testing.framework.autohealing.extractor.xpath;

import com.testlum.testing.framework.autohealing.dto.HealingElementMetadata;
import com.testlum.testing.framework.autohealing.extractor.SpecificMetadataExtractor;
import com.testlum.testing.framework.autohealing.extractor.strategy.AncestorIdExtractor;
import com.testlum.testing.framework.autohealing.extractor.strategy.AttributeExtractor;
import com.testlum.testing.framework.autohealing.extractor.strategy.IdExtractor;
import com.testlum.testing.framework.autohealing.extractor.strategy.ParentTagExtractor;
import com.testlum.testing.framework.autohealing.extractor.strategy.TagNameExtractor;
import com.testlum.testing.framework.autohealing.extractor.strategy.TextExtractor;
import com.testlum.testing.framework.autohealing.extractor.util.GenericAttributeMetadataExtractor;
import com.testlum.testing.model.pages.Xpath;
