...
public class JavascriptConstant {
    ...
    public static final String INNER_SCROLL_VERTICAL_SCRIPT_BY_XPATH =
            "document.evaluate('%s', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.scrollBy(0, %s)";
    ...
    public static final String INNER_SCROLL_VERTICAL_PERCENT_BY_XPATH =
            "document.evaluate('%s', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.scrollHeight * %s";
}
