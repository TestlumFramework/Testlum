...
public class JavascriptConstant {
    ...
    public static final String INNER_SCROLL_VERTICAL_SCRIPT_FORMAT = "document.querySelector('%s').scrollBy(0, %s)";
    ...
    public static final String INNER_SCROLL_VERTICAL_PERCENT = "document.querySelector('%s').scrollHeight * %s";
}
