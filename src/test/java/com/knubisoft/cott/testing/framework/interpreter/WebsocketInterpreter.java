...
public class WebsocketInterpreter extends AbstractInterpreter<Websocket> {
    ...
    private void openConnection(final Websocket websocket) {
        ...
        try {
            WebsocketConnectionManager wsConnectionManager = wsConnectionSupplier.get(dependencies.getEnvironment()
                    + UNDERSCORE + alias);
    ...
    private void subscribeToTopic(final WebsocketSubscribe wsSubscribe,
        ...
        wsConnectionSupplier.get(dependencies.getEnvironment() + UNDERSCORE + alias)
                .subscribeTo(wsSubscribe.getTopic());
    }
