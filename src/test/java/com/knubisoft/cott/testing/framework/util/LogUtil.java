...
import static com.knubisoft.cott.testing.framework.util.LogMessage.BODY_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.BROWSER_NAME_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.CLEAR_COOKIES_AFTER;
...
import static com.knubisoft.cott.testing.framework.util.LogMessage.CREDENTIALS_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.DESTINATION_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.ENDPOINT_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.EXECUTION_TIME_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.HTTP_METHOD_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.INVALID_CREDENTIALS_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.INVALID_SCENARIO_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.LOCAL_STORAGE_KEY;
import static com.knubisoft.cott.testing.framework.util.LogMessage.LOCATOR_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.NAME_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.REGEX_NEW_LINE;
import static com.knubisoft.cott.testing.framework.util.LogMessage.SCENARIO_NUMBER_AND_PATH_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.SCROLL_BY_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.SCROLL_DIRECTION_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.SERVER_BAD_GATEWAY_RESPONSE_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.SERVER_ERROR_RESPONSE_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.SOURCE_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.UI_COMMAND_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.TABLE_FORMAT;
import static com.knubisoft.cott.testing.framework.util.LogMessage.TESTS_RUN_FAILED;
import static com.knubisoft.cott.testing.framework.util.LogMessage.UI_EXECUTION_TIME_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.VALUE_LOG;
import static com.knubisoft.cott.testing.framework.util.LogMessage.VARIATION_LOG;
