 ...
 *       &lt;sequence&gt;
 *         &lt;element name="environment" type="{http://www.knubisoft.com/cott/testing/model/global-config}env" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Environments {
    ...
    protected List<Env> environment;
     ...
     * 
     */
    public List<Env> getEnvironment() {
        if (environment == null) {
            environment = new ArrayList<Env>();
        }
