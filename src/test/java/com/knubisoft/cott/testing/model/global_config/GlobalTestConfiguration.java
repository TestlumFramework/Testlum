 ...
 *         &lt;element name="timeout" type="{http://www.knubisoft.com/cott/testing/model/global-config}timeOutBetweenScenario"/&gt;
...
public class GlobalTestConfiguration {
    ...
    protected TimeOutBetweenScenario timeout;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link TimeOutBetweenScenario }
     *     
     */
    public TimeOutBetweenScenario getTimeout() {
        return timeout;
    }
     ...
     *     
     */
    public void setTimeout(TimeOutBetweenScenario value) {
        this.timeout = value;
    }
