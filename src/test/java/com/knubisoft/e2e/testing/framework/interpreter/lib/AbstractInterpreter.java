...
import com.knubisoft.e2e.testing.framework.util.StringPrettifier;
import com.knubisoft.e2e.testing.framework.util.TreeComparator;
...
import static com.knubisoft.e2e.testing.framework.constant.DelimiterConstant.OPEN_BRACE;
import static com.knubisoft.e2e.testing.framework.constant.DelimiterConstant.OPEN_SQUARE_BRACKET;
import static com.knubisoft.e2e.testing.framework.util.LogMessage.COMMENT_LOG;
import static com.knubisoft.e2e.testing.framework.util.LogMessage.COMPARISON_FOR_STEP_WAS_SKIPPED;
import static com.knubisoft.e2e.testing.framework.util.LogMessage.POSITION_COMMAND_LOG;
import static com.knubisoft.e2e.testing.framework.util.LogMessage.SLOW_COMMAND_PROCESSING;
