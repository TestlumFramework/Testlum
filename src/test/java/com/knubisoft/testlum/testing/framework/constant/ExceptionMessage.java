...
public class ExceptionMessage {
    ...
    public static final String NATIVE_NOT_SUPPORT_PICTURE_COMMAND = "Native testing does not support <picture> command";
    public static final String IOS_NOT_SUPPORT_PART_COMMAND = "iOS devices does not support <part> command";
