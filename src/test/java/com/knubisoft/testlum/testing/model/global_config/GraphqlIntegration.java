 ...
 *       &lt;choice&gt;
 *         &lt;element name="api" type="{http://www.knubisoft.com/testlum/testing/model/global-config}graphqlApi" maxOccurs="unbounded"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GraphqlIntegration {
     ...
     * 
     */
    public List<GraphqlApi> getApi() {
        if (api == null) {
            api = new ArrayList<GraphqlApi>();
        }
        return this.api;
    }
