 ...
 *         &lt;element name="waitUntilPageIsReady" type="{http://www.knubisoft.com/testlum/testing/model/scenario}waitUntilPageIsReady"/&gt;
    ...
    extends Ui
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "waitUntilPageIsReady", type = WaitUntilPageIsReady.class),
